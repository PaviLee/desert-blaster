...
public class Alien extends Projectile {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see desertBlasters_part3_lasers.Projectile#move()
	 */
	@Override
	public void move() {
		x += mX;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see desertBlasters_part3_lasers.Projectile#draw(java.awt.Graphics)
	 */
	@Override
	...
	public void shootLaser() {
		...
		if (Math.random() <= 0.03) {
			laser = new Laser(x, y + 10 + alienHeight / 2, 7);
		}
	}
}