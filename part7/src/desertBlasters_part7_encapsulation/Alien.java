...
public class Alien extends Projectile {
	...
	public static final int alienWidth;
	public static final int alienHeight;

	private static BufferedImage alienImage;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see desertBlasters_part6_endScreen.Projectile#move()
	 */
	@Override
	public void move() {
		x += mX;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see desertBlasters_part6_endScreen.Projectile#draw(java.awt.Graphics)
	 */
	@Override
